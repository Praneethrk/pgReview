...
(1, 'Paradise', 'Near Police station, Moodabidri', 252552, 'veg', 'B', 3500, 4700),
(2, 'VeenaPG', 'Laxmibai Circle, Moodabidri', 214748, 'nonveg', 'M', 4000, 5500),
(3, 'PraneethPG', 'Main Road, Moodabidri.', 989898989, 'veg', 'M', 3000, 6000),
(4, 'SmithaVilas', 'Near Alvas Healh Center, Moodabidri.', 787878899, 'nonveg', 'F', 3700, 4800);
