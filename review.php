...
<head>
    ...
    <title>PG Reviews | Reviews</title>
...
<body style="background-color: #f3f3f3" class="team-body">
  ...
  <center><h3 class="mt-3">Choose a PG to review </h3></center>
      ...
      while($row = $result->fetch_assoc()) {
        echo '<div class="col-md-4" data-id="${doc.id}" onclick="location.href=\'reviewform.php?pid='.$row['pid'].'\'">';
            echo '<div class="e-card">';
                echo '<div class="e-card-top" style="background-image:url(./img/'.rand(1,5).'.jpg)">';
                echo '</div>';
                echo '<div class="e-card-bottom">';
                    echo '<h5 class="strong">'.$row['pname'].'</h5>';
                    echo '<p>';
                    if($row['foodType'] == 'veg'){
                      echo '<img src="./img/veg.png" width="15px">';
                    }else{
                      echo '<img src="./img/nveg.png" width="15px">';
                    }
                    echo '&nbsp;&nbsp;&nbsp;&nbsp;';
